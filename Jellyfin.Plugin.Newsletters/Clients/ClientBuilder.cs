...
public class ClientBuilder
{
    ...
    protected (MemoryStream? resizedStream, string contentId, bool success) ResizeImage(string imagePath, int maxRetries = 5, int delayMilliseconds = 200, int targetWidth = 200, int jpegQuality = 95)
    {
